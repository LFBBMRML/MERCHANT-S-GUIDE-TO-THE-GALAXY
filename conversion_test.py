...
def test_galaxy_in_roman():
    ...
    #assert convert.galaxy_in_roman(["pish", "silver"]) == ["X", "silver"]
...
def test_roman_in_arabic():
    ...
    #assert convert.roman_in_arabic(["silver", "iron", "gold"]) == [17, 195.5, 14450]
...
def test_convert_currency():
    ...
    #assert convert.convert_currency("ow much wood could a woodchuck chuck if a woodchuck could chuck wood?") == 42